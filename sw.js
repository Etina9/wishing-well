const CACHE='level-up-life-v30-cache';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./prize-brush-bg.png','./prize-gift.png','./level-up-life-logic.js?v=14'];
